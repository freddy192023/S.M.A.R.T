  ...
  return (
    <header className="public-header">
      <a href="#home" className="brand" onClick={() => handleNavClick('home')}>
        <span className="brand-title">S.M.A.R.T <small style={{ fontSize: '0.6rem', opacity: 0.9, verticalAlign: 'middle', marginLeft: '5px', padding: '2px 6px', background: 'var(--accent-glow)', border: '1px solid var(--border-active)', color: 'var(--accent-color)', borderRadius: '4px' }}>v2.0</small></span>
